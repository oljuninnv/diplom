        ...
        <x-moonshine::layout.body>
            <x-moonshine::layout.top-bar :home_route="route('home')">
                ...
                <x-moonshine::layout.menu :elements="[
                    ['label' => 'О нас', 'url' => route('home')],
                    ['label' => 'Что ты получишь с нами', 'url' => route('home')],
                    ['label' => 'Вакансии', 'url' => route('home')],
                    ['label' => 'Связаться с нами', 'url' => route('home')]
                    ]"
                />
                ...
                @auth
                    ...
                    />
                @elseguest
                    <x-moonshine::link-button href="admin/login" class="btn-primary">
                        Войти
